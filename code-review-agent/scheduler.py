"""
scheduler.py — планировщик агента код-ревью
Проверяет GitHub на новые PR каждые N часов.
"""
...
def start():
    ...
    scheduler.add_job(
        ...
        name='Проверка новых PR на GitHub',
        misfire_grace_time=3600,
        coalesce=True,
    )

    logger.info(
        f'Планировщик запущен. Проверка {config.github_repo} '

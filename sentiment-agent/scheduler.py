"""
scheduler.py — планировщик агента анализа тональности
Запускает анализ один раз в день в настраиваемое время.
"""
...
def start():
    ...
    logger.info(
        f'Планировщик запущен. Анализ отзывов каждый день '
        f'в {config.digest_hour:02d}:{config.digest_minute:02d} ({config.timezone}).'
    )
